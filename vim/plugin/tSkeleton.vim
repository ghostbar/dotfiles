...
if !exists("g:tskelDateFormat")    | let g:tskelDateFormat    = '%B %d, %Y, %R'    | endif "{{{2
if !exists("g:tskelDateFormatYear")    | let g:tskelDateFormatYear    = '%Y'    | endif "{{{2
...
if !exists('*TSkeleton_DATEYEAR') "{{{2
    function! TSkeleton_DATEYEAR() "{{{3
        return strftime(tskeleton#GetVar('tskelDateFormatYear'))
    endf
endif
