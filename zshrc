...
plugins=(git cake command-not-found coffee cpanm debian gem git-extras git-flow git-hubflow github npm perl rails3 redis-cli ruby rvm pip vagrant virtualenvwrapper)
